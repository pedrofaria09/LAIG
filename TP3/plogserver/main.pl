...
canPassWalls(Board,[P1,P2],'N'),write('yes i can'),nl,NewPosX is P1-1,NewX is 2*NewPosX-1,NewY is 2*P2-1,checkPawnColision(Board,[NewX,NewY]),(\+availableList(List),asserta(availableList(['N']));availableList(List),\+ member('N',List),retract(availableList(_)),append(['N'],List,NewList),asserta(availableList(NewList))),write(Newlist),nl,fail;
...
canPassWalls(Board,[P1,P2],'OO'),NewPosY is P2-2,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,[NewX,NewY]),(\+availableList(List),asserta(availableList(['OO']));availableList(List),\+ member('OO',List),retract(availableList(_)),append(['OO'],List,NewList),asserta(availableList(NewList))),write(Newlist),nl,fail;
canPassWalls(Board,[P1,P2],'O'),NewPosY is P2-1,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,[NewX,NewY]),(\+availableList(List),asserta(availableList(['O']));availableList(List),\+ member('O',List),retract(availableList(_)),append(['O'],List,NewList),asserta(availableList(NewList))),write(Newlist),nl,fail;
canPassWalls(Board,[P1,P2],'EE'),NewPosY is P2+2,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,[NewX,NewY]),(\+availableList(List),asserta(availableList(['EE']));availableList(List),\+ member('EE',List),retract(availableList(_)),append(['EE'],List,NewList),asserta(availableList(NewList))),write(Newlist),nl,fail;
canPassWalls(Board,[P1,P2],'E'),NewPosY is P2+1,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,[NewX,NewY]),(\+availableList(List),asserta(availableList(['E']));availableList(List),\+ member('E',List),retract(availableList(_)),append(['E'],List,NewList),asserta(availableList(NewList))),write(Newlist),nl,fail;
