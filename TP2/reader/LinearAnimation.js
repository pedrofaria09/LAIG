...
LinearAnimation.prototype.distance= function(){
  ...
  {
        this.rotations[i-1]=Math.atan2(this.controlPoints[i][0]-this.controlPoints[i-1][0],this.controlPoints[i][2]-this.controlPoints[i-1][2]);
      }
  }
    return distance;
}
...
LinearAnimation.prototype.callMatrix = function(t){
  ...
  if(i!=this.lastIterator){
    ...
    mat4.translate(matrix,this.matrix,vec3.fromValues(0,0,0));
    mat4.rotate(matrix,matrix,this.rotations[i-1],[0, 1, 0]);
